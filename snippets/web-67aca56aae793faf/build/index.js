...
var Specials = /* @__PURE__ */ new RegExp(`[\0-
...
class ActiveResult extends ActiveSource {
  ...
  updateFor(tr, type) {
    ...
    if (result.update && (result = result.update(result, from, to, new CompletionContext(tr.state, pos, explicitPos >= 0))))
      return new ActiveResult(this.source, explicitPos, result, result.from, (_a2 = result.to) !== null && _a2 !== undefined ? _a2 : cur(tr.state));
...
// js/codemirror/syntax.grammar.js
var spec_Identifier = { __proto__: null, import: 10, define: 14, lambda: 22, if: 26, and: 30, or: 34, begin: 38, cond: 42, let: 48, "let*": 52, match: 56, display: 62 };
var parser = LRParser.deserialize({
  version: 14,
  states: "-zQYQPOOO!fQPO'#CrOOQO'#DZ'#DZOOQO'#C|'#C|OOQO'#DW'#DWOOQO'#C}'#C}QYQPOOOOQO'#DP'#DPO!sQPO,59^OhQPO'#CrOOQO,59^,59^O#UQPO,58yO#ZQPO,59QO#`QPO,59SO#nQPO,59UO$PQPO,59WO$bQPO,59YO$sQPO,59[O%UQPO,59_O%ZQPO,59aO#`QPO,59cO%`QPO,58|O#`QPO,59fOOQO-E6{-E6{OOQO-E6}-E6}OOQO1G.x1G.xO%eQPO1G.eO%jQPO'#D[O#`QPO1G.lO#`QPO1G.nO%rQPO1G.pOOQO1G.p1G.pO&TQPO1G.rOOQO1G.r1G.rO&fQPO1G.tOOQO1G.t1G.tO&wQPO'#D]OOQO'#DQ'#DQO$sQPO1G.vO&|QPO1G.vO'RQPO1G.yO'ZQPO1G.{O'cQPO1G.}O#`QPO1G.hO'kQPO1G/QOOQO7+$P7+$POOQO'#DO'#DOO'pQPO,59vOOQO,59v,59vO'xQPO7+$WO#`QPO7+$YOOQO7+$[7+$[OOQO7+$^7+$^OOQO7+$`7+$`O#`QPO,59wOOQO-E7O-E7OO'}QPO7+$bOOQO7+$b7+$bO(SQPO7+$eO#`QPO7+$eO([QPO7+$gO#`QPO7+$gO(dQPO'#D`OOQO'#DR'#DRO(rQPO7+$iOOQO7+$i7+$iO(zQPO7+$SOOQO7+$l7+$lOOQO-E6|-E6|OOQO1G/b1G/bOOQO<<Gr<<GrO)PQPO<<GtO)UQPO1G/cOOQO<<G|<<G|O#`QPO<<HPO)ZQPO<<HPO#`QPO<<HRO)`QPO<<HRO)eQPO'#CyOOQO'#Da'#DaO#`QPO,59zOOQO-E7P-E7POOQO<<HT<<HTOOQO<<Gn<<GnOOQOAN=`AN=`OOQO7+$}7+$}O)vQPOAN=kOOQOAN=kAN=kO){QPOAN=mOOQOAN=mAN=mOOQO'#DS'#DSO*QQPO,59eOOQO,59e,59eO*cQPO1G/fOOQOG23VG23VOOQOG23XG23XOOQO-E7Q-E7QOOQO1G/P1G/POOQO7+%Q7+%Q",
  stateData: "*h~OyOSPOS~OSQOWQOXQO|PO~OSQOWQOXQOZ[O]]O_^Oa_Oc`OeaOhbOjcOldO{YO|XO~OTZOVeOofO~PhOSQOWQOXQO{iO|XO~OSjO~O|kO~OSQOWQOXQO|XO~OSQOWQOXQO{oO|XO~OSQOWQOXQO{qO|XO~OSQOWQOXQO{sO|XO~OSQOWQOXQO|XO!QtO~O|xO~O|yO~OS{O~O{}O~OS!OO{!QO~OSQOWQOXQO{!TO|XO~OSQOWQOXQO{!UO|XO~OSQOWQOXQO{!VO|XO~OS!WO~O{!ZO~O{!]O!QtO~O{!_O!QtO~O{!cO!Q!`O~O{!eO~OS!OO{!gO~O{!hO~O{!kO~O{!lO!QtO~O{!nO!QtO~OS!qOW!qOX!qO|!pO~O{!tO!Q!`O~O{!uO~O{!vO~O!R!wO~O{!yO~O{!{O~OS!qOW!qOX!qO{#OO|!pO~O{#QO~O{#RO~OS!qOW!qOX!qO{#TO|!pO~O!R#UO~O",
  goto: "&R!UPPP!VPP!VPPP!ZP!ZP!ZP!ZP!ZP!ZP!Z!ZP!ZP!ZP!w!VP!V!|#S#Y#m#{$RPPP$XPP$]%k%nPP%v%zTSOU!VQOPUWX]^_`adflmnprv{!S!W!]!_!l!n!rV!q!`!p!}QUORgUQ!PkR!f!PSWPXWhWnprQn^Qp_Rr`QvaU!Xv![!^Q![xR!^yQ!bzR!s!bQ!}!pR#S!}TTOUSROUbVPWX^_`nprQm]QwaQzdQ|fQ!RlQ!SmQ!YvQ!d{Q!i!SQ!j!WQ!m!]Q!o!_Q!x!lQ!z!nR#P!rRl[]uavxy![!^T!az!bQ!r!`T!|!p!}",
  nodeNames: "\u26A0 LineComment Program Import Identifier import Define define String Boolean Lambda lambda If if And and Or or Begin begin Cond cond Application Let let LetStar let* Match match PApp Display display SExpr",
  maxTerm: 51,
  skippedNodes: [0, 1],
  repeatNodeCount: 6,
  tokenData: "&V~RcXY!^YZ!^]^!^pq!^rs!ost$]xy$kyz$pz{$u{|$u}!O$u!Q![$u!]!^%d!_!`$u!c!}$u!}#O%{#P#Q&Q#R#S$u#T#o$u~!cSy~XY!^YZ!^]^!^pq!^~!rVOr!ors#Xs#O!o#O#P#^#P;'S!o;'S;=`$V<%lO!o~#^OW~~#aRO;'S!o;'S;=`#j;=`O!o~#mWOr!ors#Xs#O!o#O#P#^#P;'S!o;'S;=`$V;=`<%l!o<%lO!o~$YP;=`<%l!o~$`Q#Y#Z$f#h#i$f~$kOX~~$pO|~~$uO{~~$zWS~z{$u{|$u}!O$u!Q![$u!_!`$u!c!}$u#R#S$u#T#o$u~%iSP~OY%dZ;'S%d;'S;=`%u<%lO%d~%xP;=`<%l%d~&QO!Q~~&VO!R~",
  tokenizers: [0],
...
// js/codemirror/language.ts
var ScamperLanguage = LRLanguage.define({
  parser: parser.configure({
    props: [
      ...
      styleTags({
        "and begin cond define display if import lambda let let* letrec match or struct": tags.keyword,
...
var ssr = global === null;
var document2 = !ssr ? global.document : undefined;
...
var Split = function(idsOption, options) {
  ...
  var gutter2 = getOption(options, "gutter", defaultGutterFn);
  ...
  elements = ids.map(function(id, i) {
    ...
    if (i > 0) {
      ...
      pair2[aGutterSize] = getGutterSize(gutterSize, i - 1 === 0, false, gutterAlign);
      pair2[bGutterSize] = getGutterSize(gutterSize, false, i === ids.length - 1, gutterAlign);
    ...
    if (i > 0) {
      var gutterElement = gutter2(i, direction, element.element);
...
// js/webaudiofont/WebAudioFontPlayer.ts
class WebAudioFontChannel {
  ...
  bandEqualizer = function(from, frequency) {
    ...
    filter.Q.setTargetAtTime(1, 0, 0.0001);
    from.connect(filter);
    return filter;
  };
}
...
class WebAudioFontPlayer {
  ...
  queueWaveTable = function(audioContext, target, preset, when, pitch, duration, volume, slides) {
    ...
    if (zone) {
      ...
      var baseDetune = zone.originalPitch - 100 * zone.coarseTune - zone.fineTune;
      var playbackRate = 1 * Math.pow(2, (100 * pitch - baseDetune) / 1200);
      var startWhen = when;
      ...
      if (slides) {
        if (slides.length > 0) {
          ...
          for (var i = 0;i < slides.length; i++) {
            ...
            var newPlaybackRate = 1 * Math.pow(2, (100 * nextPitch - baseDetune) / 1200);
...
class WebAudioFontReverberator {
  constructor(audioContext) {
    ...
    this.compressorWet.gain.setTargetAtTime(1, 0, 0.0001);
    this.compressorDry.gain.setTargetAtTime(0, 0, 0.0001);
    var threshold = -35;
    var knee = 35;
    var ratio = 8;
    var attack = 0.02;
...
class Player {
  ...
  player;
  audioContext;
  loadInstrument(instr, isPercussion = false) {
    const path = isPercussion ? mkPercPath(instr, this.fontName) : mkTonePath(instr, this.fontName);
    const name2 = isPercussion ? mkPercId(instr, this.fontName) : mkToneId(instr, this.fontName);
    console.log(`loading ${name2} (${path})...`);
    if (window[name2] === undefined) {
      this.player.loader.startLoad(this.audioContext, path, name2);
      this.player.loader.waitLoad(() => {
        console.log(`loaded ${name2} (${path})!`);
      });
    }
  }
  constructor() {
  ...
  playNote(time, duration, note, instrument, velocity) {
    ...
    this.player.queueWaveTable(this.audioContext, this.audioContext.destination, this.getInstrument(instr, isPercussion), startTime + time / 1000, note, duration / 1000, velocity);
  }
  stop() {
...
// js/index.ts
function createEditor(doc2, parent, onUpdate, onLinting) {
  const update = EditorView.updateListener.of((update2) => {
    if (update2.docChanged) {
      onUpdate(update2.view);
    }
  });
  const view = new EditorView({
    ...
    extensions: [
      ...
      ScamperSupport(),
      linter((view2) => onLinting(view2)),
      update
    ]
  });
  view.get_doc = function() {
    return this.state.doc.toString();
  };
  view.set_doc = function(content2) {
    this.dispatch({
      changes: {
        from: 0,
...
function createDiagnostic(from, to, severity, message) {
  return {
    from,
    to,
    severity,
...
function createSplit(elements, sizes) {
  split_es_default(elements, {
    sizes
  });
}
